...
| 67 | 2026-08-15 23:56 | (pendiente) | Registro pulido (logo clickeable a Inicio, header más grande, fix de visibilidad de los campos de formulario `!important` en `--border-width`, fix de orden en el header, fix de crowding en móvil) + prueba E2E real de registro en Android nativo (dark mode, vía adb) + `tipo_cuenta` eliminado del registro (redundante con "¿ofreces servicios?", 264 tests backend en verde) | 1 h 33 min |
